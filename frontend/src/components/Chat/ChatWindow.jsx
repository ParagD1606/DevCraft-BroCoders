...
import { Loader2, MoreVertical, Paperclip, Phone, Send, Users, Video } from 'lucide-react';
...
const ChatWindow = ({ activeConversation, currentUser, messages, onSend, connectionStatus }) => {
    ...
    return (
        <div className="flex-1 flex flex-col h-full bg-gradient-to-b from-slate-50 via-white to-slate-50">
            {/* Header */}
            <div className="bg-white/95 backdrop-blur p-4 border-b border-slate-200 flex justify-between items-center shadow-sm z-10">
            ...
            {/* Messages */}
            <div className="flex-1 overflow-y-auto p-4 md:p-6 bg-[radial-gradient(circle_at_top_left,rgba(207,250,254,0.45),transparent_38%),radial-gradient(circle_at_bottom_right,rgba(224,231,255,0.35),transparent_35%)]">
            ...
            {/* Input Area */}
            <div className="bg-white/95 backdrop-blur p-4 border-t border-slate-200">
