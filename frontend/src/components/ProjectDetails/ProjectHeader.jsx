            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
                <div>
                    <div className="flex items-center gap-3 mb-2">
                        ...
                        <span className={`px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wide ${project.status === 'Recruiting' ? 'bg-green-100 text-green-700' : 'bg-blue-100 text-blue-700'
                            }`}>
                            {project.status}
                        </span>
                    </div>
                    <p className="text-lg text-gray-600 max-w-2xl">{project.shortDescription}</p>
                </div>
